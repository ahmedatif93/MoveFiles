...
GO
/****** Object:  Table [GCC].[GCC_AIPs]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [GCC].[GCC_CountryCodesLookup]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [GCC].[GCC_Currencies]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [GCC].[GCC_CurrencyCodesLookup]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [GCC].[GCC_CustomsDataTypesLookup]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [GCC].[GCC_CustomsDeclarations]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [GCC].[GCC_CustomsDeclarations](
	...
	[DeliveryOrderNumber] [nvarchar](70) NULL,
	...
	[IntercessorCompany] [nvarchar](70) NULL,
	...
	[ExportedTo] [nvarchar](70) NULL,
	[NumberOfPackages] [int] NULL,
	[BlAwbManifestNo] [nvarchar](70) NULL,
	...
	[ClearingAgentName] [nvarchar](70) NULL,
...
GO
/****** Object:  Table [GCC].[GCC_CustomsPortTypesLookup]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [GCC].[GCC_DataEntityTypes]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [GCC].[GCC_DocumentTypesLookup]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [GCC].[GCC_DueNumbers]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [GCC].[GCC_DueNumberStatusesLookup]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [GCC].[GCC_GCCPortCodesLookup]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [GCC].[GCC_ItemDetails]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [GCC].[GCC_Items]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [GCC].[GCC_LanguageCodesLookup]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [GCC].[GCC_Packages]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [GCC].[GCC_PackageTypesLookup]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [GCC].[GCC_PaymentMethodsLookup]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [GCC].[GCC_Payments]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [GCC].[GCC_ProviderFeedbacks]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [GCC].[GCC_ProxyLogs]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [GCC].[GCC_ProxyLogs](
	...
	[HttpPath] [nvarchar](500) NOT NULL,
...
GO
/****** Object:  Table [GCC].[GCC_RequestsLogging]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [GCC].[GCC_RequestsLogging](
	[Id] [bigint] IDENTITY(1,1) NOT NULL,
	[Direction] [char](1) NOT NULL,
	[Endpoint] [nvarchar](500) NULL,
	[HttpMethod] [nvarchar](10) NULL,
	[ClientId] [nvarchar](10) NULL,
	[XRequestId] [nvarchar](100) NULL,
	[XCorrelationId] [nvarchar](100) NULL,
	[XClientId] [nvarchar](100) NULL,
	[Headers] [nvarchar](max) NULL,
	[RequestBody] [nvarchar](max) NULL,
	[DataEntityId] [bigint] NULL,
	[DataEntityTypeId] [bigint] NULL,
...
GO
/****** Object:  Table [GCC].[GCC_ResponseMockData]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [GCC].[GCC_ResponseMockData](
	[Id] [int] IDENTITY(1,1) NOT NULL,
...
GO
/****** Object:  Table [GCC].[GCC_ResponsesLogging]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [GCC].[GCC_ResponsesLogging](
	[Id] [bigint] IDENTITY(1,1) NOT NULL,
...
GO
/****** Object:  Table [GCC].[GCC_Restrictions]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [GCC].[GCC_Restrictions](
	[Id] [bigint] IDENTITY(1,1) NOT NULL,
	[ItemId] [bigint] NOT NULL,
	[Agency] [nvarchar](70) NOT NULL,
	[ReleaseRef] [nvarchar](70) NULL,
PRIMARY KEY CLUSTERED 
(
	[Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [SECONDARY]
...
GO
/****** Object:  Table [GCC].[GCC_RiskResultsLookup]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [GCC].[GCC_TransferReceiptListOfDues]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [GCC].[GCC_TransferReceipts]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [GCC].[GCC_UnitCodesLookup]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [GCC].[GCC_ValuationMethodsLookup]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [GCC].[GCC_ProxyLogs] ADD  DEFAULT (getutcdate()) FOR [CreatedAt]
GO
ALTER TABLE [GCC].[GCC_RequestsLogging] ADD  DEFAULT (getdate()) FOR [RequestTime]
GO
ALTER TABLE [GCC].[GCC_ResponsesLogging] ADD  DEFAULT (getdate()) FOR [ResponseTime]
GO
...
GO
ALTER TABLE [GCC].[GCC_ResponsesLogging]  WITH CHECK ADD FOREIGN KEY([RequestId])
REFERENCES [GCC].[GCC_RequestsLogging] ([Id])
GO
ALTER TABLE [GCC].[GCC_Restrictions]  WITH CHECK ADD FOREIGN KEY([ItemId])
REFERENCES [GCC].[GCC_Items] ([Id])
GO
ALTER TABLE [GCC].[GCC_RequestsLogging]  WITH CHECK ADD CHECK  (([Direction]='O' OR [Direction]='I'))
GO
/****** Object:  StoredProcedure [GCC].[DueNumberPreviewSP_QRGCC]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [GCC].[Gcc_customdeclartioninquiryairExport]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
--exec BayanAirExportSp_V2023 8562355,''
CREATE       PROCEDURE [GCC].[Gcc_customdeclartioninquiryairExport]  (
	@DeclarationId VARCHAR(50)
	,@Phase NVARCHAR(30)
	)
AS
BEGIN
	DECLARE @RelLetterNo NVARCHAR(200)

	SET @RelLetterNo = ISNULL(dbo.GetReleaseLetterNumber(@DeclarationId), '')

	DECLARE @MaqasaCutOffDate DATETIME

	SELECT @MaqasaCutOffDate = ConfigValue
	FROM Configurations
	WHERE ConfigName = 'MaqasaStampCutOffDate'
...
SELECT @ADDutyAmount=SUM(OC.DutyValue) 
 ...
 OR DutyId= dbo.KWConstantFn('GBL_Constants.Duties.AntiDumpingCement_Iran')      
	...
	SELECT
		...
		,isnull(' B ' + DeclarationDetails.AirwayBillNumber, '') + CASE 
			WHEN @RelLetterNo = ''
				THEN ''
			ELSE SUBSTRING(N'رقم جهة الإفراج: ' + @RelLetterNo, 0, 200)
			END AS 'B\L - AWB No./Manif'
		,UPPER(OwnerLoc.LocalDescription) AS "Carrier Type"
		...
		,UPPER(ISNULL(isnull(ConsigneeOrg.LocalDescription, ConsigneeOrg.NAME), isnull(trial_ara.FirstName + ' ' + trial_ara.LastName, trial.FirstName + ' ' + trial.LastName))) AS "Consignee"
		,ISNULL(DeclarationDetails_ara.CaptainName, DeclarationDetails.CaptainName) AS "Captain Name"
		,ISNULL(UPPER(ISNULL(Carriers_ara.CarrierName, Carriers.CarrierName)), '-') "Carrier Name"
		,DeclarationDetails.VoyageFlightNo "Voyage/Flight No."
		,ISNULL(ISNULL(DeclarationDetails_ara.BeneficiaryName, DeclarationDetails.BeneficiaryName), '-') AS 'Exported To'
		,ISNULL(LP_cont_name.LocalDescription, '-') + ' / ' + ISNULL(UPPER(LP.LocalDescription), '-') AS "Port Of Loading"
		,ISNULL(UPPER(DP.LocalDescription), '-') "Port Of Discharge"
		,UPPER(distanation.LocalDescription) "Destination"
		,ConsigneeOrg.TradeLicenseNumber
		,isnull(InterCessor.LocalDescription, '-') AS Intercessor
		,Declarations.DeclarationId
		,ConsigneeOrg.TradeLicenseNumber AS "PassportNumber"
		,UPPER(ISNULL(DeclarationDetails_ara.ShippingAgent, DeclarationDetails.ShippingAgent)) AS ENDorsementAgentName
		,ISNULL(ConsigneeOrg.OrganizationId, trial.PersonalId) AS ConsigneeId
		,'' AS ENDorsementID
		,'Marks: ' + dbo.GetRefDeclForDeclFn(@DeclarationId) + ' ' + ISNULL(SUBSTRING(CASE ISNULL(DeclarationDetails_ARA.MarksAndNumbers, '')
					WHEN ''
						THEN DeclarationDetails.MarksAndNumbers
					ELSE DeclarationDetails_ARA.MarksAndNumbers
					END, 0, 200), '') + isnull('(' + isnull(EType.LocalDescription, Etype.NAME) + ':' + Convert(VARCHAR(2), isnull(Declarations.ExpiryPeriod, 0)) + ' / ' + Convert(NVARCHAR(10), TempAdmissionExpiredOn, 103) + N' : تأريخ الإنتهاء' + ')', '')
 AS Marks
		,'Numbers: ' AS Numbers
		,CASE ISNULL(DeclarationDetails_ARA.MarksAndNumbers, '')
			WHEN ''
				THEN DeclarationDetails.MarksAndNumbers
			ELSE DeclarationDetails_ARA.MarksAndNumbers
			END AS MarksAndNumbers
		,       
		Declarations.NWt AS 'Net Weight'
		,dbo.GetValueNoZeroEnd(Declarations.GWt) AS 'Gross Weight'
		,ISNULL(weightUOM.LocalDescription, ' ') AS 'Measurement'
		,	N'مانفست' + '=' + dbo.GetValueNoZeroEnd(convert(nvarchar(20), isnull(HB.QuantityManifested, 0))) + ' ' + MUL.LocalDescription AS 'No of Packages'
		--Declarations.NoOfPackages AS 'No of Packages'
		,'-' AS 'InspectionReasons'
		,'-' AS 'InspectionInspector'
		,N'  مدقق ' + ':' + isnull(Declarations.AuditorId, '-') AS 'InspectionSuprtvisor'
		,
		dbo.GetBayanInvoices_QRGCC(@DeclarationId)
		+	
		CASE 
			WHEN declarations.Datecreated > @MaqasaCutOffDate
				THEN '--'
			ELSE ISNULL(dbo.RefBayan(Declarations.DeclarationId), '') 
			END 
			AS 'InspectionRemarks'
		,(dbo.fn_formatdate(ReleaseDate, 'dd/MM/yyyy hh:mm:ss tt') + ' / ' + Declarations.ReleasedBy) AS 'InspectionReleaseDate'
...
AND DA.CountriesAEOListId not in (select ISNULL(CountriesAEOListId,0) from KuwaitAEOList))>0 then 'y' else 'n' end as ISGCCAEOLogo
,case when (select COUNT(1) from DeclarationAEOList DA JOIN Declarations D ON DA.DeclarationId=D.DeclarationId     
where DA.StateId <> 'DeclarationAEOListDeletedState' and D.StateId not in ('DeclarationCreatedState','DeclarationModifiedState','DutyCalculatedState','DeclarationRejected')     
and DA.DeclarationId= Declarations.DeclarationId    
AND DA.CountriesAEOListId in (select ISNULL(CountriesAEOListId,0) from KuwaitAEOList))>0 then 'y' else 'n' end as ISKWTAEOLogo
...
, '' as RiskOutcome ---atif 
	FROM Declarations
	LEFT OUTER JOIN DeclarationDetails ON Declarations.DeclarationDetailId = DeclarationDetails.DeclarationDetailId
	LEFT JOIN CustomsControlProcedures ON Declarations.CustomsControlProcedureId = CustomsControlProcedures.CustomsControlProcedureId
	LEFT OUTER JOIN MeasurementUnits weightUOM ON Declarations.WUOM = weightUOM.MeasurementUnitId
	...
	LEFT OUTER JOIN DeclarationDetails_ara ON Declarations.DeclarationDetailId = DeclarationDetails_ara.DeclarationDetailId
	LEFT OUTER JOIN Carriers Carriers ON DeclarationDetails.CarrierName = Carriers.CarrierId
	LEFT OUTER JOIN Carriers_ara Carriers_ara ON DeclarationDetails_ara.CarrierName = Carriers_ara.CarrierId
	LEFT OUTER JOIN Types DeclarationTypes ON Declarations.DeclarationType = DeclarationTypes.TypeId
	LEFT OUTER JOIN Locations LP ON DeclarationDetails.PortsOfLoadingId = LP.LocationId
	LEFT OUTER JOIN Locations LP_cont_name ON DeclarationDetails.PortsOfLoadingId = LP.LocationId
		AND ISNULL(LP.ParentId, LP.LocationId) = LP_cont_name.LocationId
	LEFT OUTER JOIN Locations DP ON DeclarationDetails.PortsOfDischargeId = DP.LocationId
	LEFT OUTER JOIN Organizations AgentOrg ON Declarations.AgentId = AgentOrg.OrganizationId
	LEFT OUTER JOIN People trial ON Declarations.ConsigneeId = trial.PersonalId
	LEFT OUTER JOIN People_ara trial_ara ON trial_ara.PersonalId = trial.PersonalId
	LEFT OUTER JOIN Locations distanation ON DeclarationDetails.PortsOfDischargeId = DP.LocationId
		AND ISNULL(DP.ParentId, DP.LocationId) = distanation.LocationId
	LEFT OUTER JOIN Organizations InterCessor ON InterCessor.OrganizationId = Declarations.InterCessorId
	...
	LEFT OUTER JOIN DeliveryOrders DO ON Declarations.DeliveryOrderId = DO.DeliveryOrderId
--	   left outer join Users U on U.UserId=Declarations.CreatedBy
	LEFT OUTER JOIN  housebills hb on hb.DeliveryOrderId = DO.DeliveryOrderId		
		left outer join MeasurementUnits MUL on MUL.MeasurementUnitId  = isnull(HB.QtyManifestedUnitOfMeasurement, HB.QtyLandedUnitOfMeasurement)
           ...
           LEFT OUTER JOIN GCC_UnitCodesLookup gccuom
                        ON gccuom.measurementunitid = MUL.MeasurementUnitId -- atif 
           LEFT OUTER JOIN GCC_CountryCodesLookup FD
                        ON FD.locationid = declarations.finaldestination --atif 
	WHERE (Declarations.DeclarationId = @DeclarationId)
END



GO
/****** Object:  StoredProcedure [GCC].[Gcc_customdeclartioninquiryairimport]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [GCC].[GCC_CustomDeclartionInquiryDutyInfo]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [GCC].[GCC_CustomDeclartionInquiryInvDetails]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
CREATE   PROCEDURE [GCC].[GCC_CustomDeclartionInquiryInvDetails]              
 ...
 OR CIID.DutyId= dbo.KWConstantFn('GBL_Constants.Duties.AntiDumpingCement_Iran')      
  ...
  null as DumpingDuty                      
  ,GCC_CountryCodesLookup.Code as originCountryCode --added by atif  
         , GCCCurrency.code  as CurrencyTypeCode  -- added by atif   
   --,GCCUOM.code as WUOM --added by atif  gives an error in join 
   ,GCC_PackageTypesLookup.Code  as  PackageTypeCode -- added by atif   
 ...
 INNER JOIN dbo.Types  TYPES_INV ON dbo.CommercialInvoices.TypeId =TYPES_INV.TypeId              
   ...
   left outer join GCC_CountryCodesLookup on GCC_CountryCodesLookup.LocationId =dbo.CommercialInvoiceItems.CountryOfOrigin  -- added by atif
   left outer Join GCC_CurrencyCodesLookup  GCCCurrency on GCCCurrency.CurrencyId=dbo.CommercialInvoices.CurrencyId  -- added by atif
...
GO
/****** Object:  StoredProcedure [GCC].[Gcc_customdeclartioninquiryLandExport]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
CREATE     PROCEDURE [GCC].[Gcc_customdeclartioninquiryLandExport] (@DeclarationId VARCHAR(50), @Phase nvarchar(30)) AS  
BEGIN  
...
Declare @MaqasaCutOffDate datetime
select  @MaqasaCutOffDate = ConfigValue from Configurations where ConfigName='MaqasaStampCutOffDate'
...
SELECT @ADDutyAmount=SUM(OC.DutyValue) 
 ...
 isnull(dbo.TrimDecNumberFn(Declarations.DeclarationNumber), Declarations.TempDeclNumber) AS DeclarationNumber,     
   ...
   dbo.GetBCLocalURLFn('empty=true&Show_Text=Y&X=0.06&text=' + Declarations.TempDeclNumber) AS xpath,  
   dbo.GetBCLocalURLFn('Show_Text=Y&text=' + Declarations.TempDeclNumber) AS ypath,  
               isnull(' B ' + DeclarationDetails.AirwayBillNumber, '')     +    
         case 
	  WHEN @RelLetterNo='' THEN '' 
	  else SUBSTRING( N'رقم جهة الإفراج: ' + @RelLetterNo,0,200) 
   END as 'B\L - AWB No./Manif',      
   UPPER(OwnerLoc.LocalDescription) as "Carrier Type",  
   CONVERT(CHAR(12),Declarations.DeclarationDate) AS [Date],   
   --UPPER(BillType.LocalDescription) "BillType_1",  
   CustomsControlProcedures.CCPCode  AS "BillType_1",  
   UPPER(SUBSTRING(CustomsControlProcedures.LocalDescription,0,30)) "BillType",  
      DO.DeliveryOrderNumber, 
   UPPER(ISNULL(isnull(ConsigneeOrg.LocalDescription,ConsigneeOrg.name)  , isnull(trial_ara.FirstName + ' ' + trial_ara.LastName, trial.FirstName + ' ' + trial.LastName))) AS "Consignee",    
   ...
   DeclarationDetails.VoyageFlightNo "Voyage/Flight No.",   
   ISNULL(ISNULL(DeclarationDetails_ara.BeneficiaryName, DeclarationDetails.BeneficiaryName),'-') AS 'Exported To',       
   ISNULL(LP_cont_name.LocalDescription,'-')  AS "Port Of Loading",      
   ISNULL(UPPER(DP.LocalDescription),'-') "Port Of Discharge",  
   UPPER(distanation.LocalDescription) "Destination",  
   ConsigneeOrg.TradeLicenseNumber,  
    isnull(InterCessor.LocalDescription, '-') AS Intercessor,  
   ...
   ISNULL(ConsigneeOrg.OrganizationId,trial.PersonalId) AS ConsigneeId,  
   '' AS ENDorsementID,  
   'Marks: ' + dbo.GetRefDeclForDeclFn(@DeclarationId) + ' ' + ISNULL(SUBSTRING(case ISNULL(DeclarationDetails_ARA.MarksAndNumbers,'') WHEN '' THEN DeclarationDetails.MarksAndNumbers else  DeclarationDetails_ARA.MarksAndNumbers END,0,200),'') + isnull('('
 + isnull(EType.LocalDescription, Etype.name) + ':' + Convert(varchar(2), isnull(Declarations.ExpiryPeriod, 0))  + ' / '+ Convert(nvarchar(10), TempAdmissionExpiredOn,103) +  N' : تأريخ الإنتهاء' + ')', '' ) +   
   case   
   When Declarations.Maqasa is not null then ' / ' + Convert(varchar(3),@MaqasaCount) + N' : عدد بيانات المقاصة'   
  Else ''  
   End  
   + ISNULL(dbo.GetAEODeclListFn_GCC(@DeclarationId), '')
   AS Marks,  
  
   'Numbers: ' AS Numbers,   
   case ISNULL(DeclarationDetails_ARA.MarksAndNumbers,'') WHEN '' THEN DeclarationDetails.MarksAndNumbers else  DeclarationDetails_ARA.MarksAndNumbers END AS MarksAndNumbers,   
              Declarations.NWt AS 'Net Weight',    
              dbo.GetValueNoZeroEnd(Declarations.GWt) AS 'Gross Weight',    
              ISNULL(weightUOM.LocalDescription,' ') AS 'Measurement',    
   --Declarations.NoOfPackages AS 'No of Packages',  
   ...
   '-' AS 'InspectionInspector',   
  N'  مدقق ' + ':' +  isnull(Declarations.AuditorId, '-') AS 'InspectionSuprtvisor' ,
	  --DBO.GetAEODeclListFn (Declarations.DeclarationId)
	  dbo.GetBayanInvoices_QRGCC(Declarations.DeclarationId)
	 + 
  CASE 
	when declarations.Datecreated > @MaqasaCutOffDate then '--'
	else iSNULL( dbo.RefBayan(Declarations.DeclarationId), '')

  end AS 'InspectionRemarks',      
  dbo.GetBayanInvoices(@DeclarationId) AS 'InspectionRemarks',
 (dbo.fn_formatdate(ReleaseDate, 'dd/MM/yyyy hh:mm:ss tt')+' / '+Declarations.ReleasedBy)  AS 'InspectionReleaseDate',  
   ISNULL(AgentOrg.LocalDescription,'-') AS 'ClearingAgent',  
   ISNULL(AgentOrg.TradeLicenseNumber,'-') AS 'LicenceNo',   
   Declarations.AuditorId,  
   ...
   Declarations.ApprovedDate,  
    --(Select UPPER(ISNULL(dbo.[GetNameByPersonalId_Rpt_Fn](U.PersonalId),'-'))) as CreatedBy,
	Declarations.CreatedBy AS CreatedBy,
   'Land' PortType, '' FormatNum ,  
     '-' as 'Route',  
 '-' as 'TransitDate' ,  
 '-'  AS 'TransitInspectorDate'  , @Phase as 'Phase' 
 ,ConsigneeOrg.OrganizationCode as UnifiedCustomsCode
		,'' AS VAT
		,'' AS ExciseTax
		,@ADDutyAmount AS DumpingDuty
...
, '' as RiskOutcome ---atif 
 FROM Declarations   
   LEFT OUTER JOIN CustomsControlProcedures ON Declarations.CustomsControlProcedureId = CustomsControlProcedures.CustomsControlProcedureId   
   LEFT OUTER JOIN DeclarationDetails ON Declarations.DeclarationDetailId = DeclarationDetails.DeclarationDetailId   
 LEFT OUTER JOIN       Locations LP ON DeclarationDetails.PortsOfLoadingId = LP.LocationId   
 LEFT OUTER JOIN          Locations LP_cont_name ON DeclarationDetails.PortsOfLoadingId = LP.LocationId AND ISNULL(LP.ParentId, LP.LocationId) = LP_cont_name.LocationId  
  LEFT OUTER JOIN  MeasurementUnits weightUOM ON Declarations.WUOM = weightUOM.MeasurementUnitId     
  LEFT OUTER JOIN Organizations ConsigneeOrg ON Declarations.ConsigneeId = ConsigneeOrg.OrganizationId   
   --LEFT OUTER JOIN Declarations_ara ON Declarations.DeclarationId = Declarations_ara.DeclarationId  
   LEFT OUTER JOIN DeclarationDetails_ara ON Declarations.DeclarationDetailId = DeclarationDetails_ara.DeclarationDetailId   
   ...
   LEFT OUTER JOIN       Locations DP ON DeclarationDetails.PortsOfDischargeId = DP.LocationId   
          LEFT OUTER JOIN Organizations AgentOrg ON Declarations.AgentId = AgentOrg.OrganizationId  
   LEFT OUTER JOIN People  trial ON Declarations.ConsigneeId = trial.PersonalId   
 left outer join  People_ara  trial_ara on  trial.PersonalId  = trial_ara.PersonalId  
          LEFT OUTER JOIN Locations distanation ON DeclarationDetails.PortsOfDischargeId = DP.LocationId AND ISNULL(DP.ParentId, DP.LocationId) = distanation.LocationId   
   LEFT OUTER JOIN Organizations InterCessor on InterCessor.OrganizationId= Declarations.InterCessorId  
          LEFT OUTER JOIN Locations OwnerLoc ON Declarations.OwnerLocId = OwnerLoc.LocationId    
   left outer join Types EType on EType.TypeId =  Declarations.ExpiryType 
       LEFT OUTER JOIN DeliveryOrders DO ON Declarations.DeliveryOrderId =DO.DeliveryOrderId 
...
GO
/****** Object:  StoredProcedure [GCC].[Gcc_customdeclartioninquiryLandImport]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
CREATE     PROCEDURE [GCC].[Gcc_customdeclartioninquiryLandImport] (
            @DeclarationId VARCHAR(50) , @Phase nvarchar(30)
		) 
AS
BEGIN
...
--Below added in Case condition for BWH-(DR-Import) Bayan in print to show Org Name as Port of loading
SELECT @BWHOrgPOL=ISNULL(UPPER(DeclReqOrg.LocalDescription),'-')   
From Declarations D 
LEFT OUTER JOIN HouseBills HB ON D.DeliveryOrderId=HB.DeliveryOrderId 
LEFT OUTER JOIN DeclareRequest DR ON HB.HouseBillId=DR.HouseBillId 
LEFT OUTER JOIN  Organizations DeclReqOrg on DeclReqOrg.OrganizationId = DR.OwnerOrgId
where DeclarationId=@DeclarationId and ISNULL(DR.DRBillType,0)=dbo.KWConstantfn('GBL_Locations.DRType.DRImport')    
...
SELECT   
	isnull(dbo.TrimDecNumberFn(Declarations.DeclarationNumber), Declarations.TempDeclNumber) AS DeclarationNumber,   
	      ...
	      case when isnull(CargoVw.JourneyId, '') != '' then CargoVw.DeliveryOrderNumber else '' End as 'DeliveryOrderNumber', 	
 	      CargoVw.ConsigneeName as 'Consignee',
	     dbo.GetDriversFn(CargoVw.JourneyId)  as  'Captain Name', 
	     dbo.GetCarriersFn(CargoVw.JourneyId)  as  'Carrier Name',
	      CargoVw.Voyage  as 'Voyage/Flight No.',
	      CargoVw.ExportedTo_LA as 'Exported To',
	             Case when @BWHOrgPOL <> '-' then @BWHOrgPOL  
	   ELSE ISNULL(CargoVw.PortOfLoading_Cont_Name,'-')  + ' / ' + ISNULL(UPPER(CargoVw.PortOfLoading),'-') END AS "Port Of Loading",    
          ...
          CargoVw.PortOfDischarge AS 'Port Of Discharge',
          CASE WHEN ISNULL(declarations.FinalDestination,'') ='' THEN CargoVw.PortOfDestination ELSE
          UPPER(FDC.LocalDescription) END as 'Destination',
	      CargoVw.TradeLicenseNumber as 'TradeLicenseNumber',
	      CargoVw.Intercessor as 'Intercessor',
	      Declarations.DeclarationId AS 'DeclarationId',  	
	      CargoVw.TradeLicenseNumber AS 'PassportNumber',  
	      ...
	      CargoVw.ConsigneeId as 'ConsigneeId',
	      ''  AS ENDorsementID ,
	  	'Marks: ' + CASE ISNULL(CargoVw.Marks,'') WHEN '' THEN '-' ELSE  ISNULL(SUBSTRING(CargoVw.Marks,0,100),'-') END + '<br/>' + 
	  	'Numbers: '  + dbo.GetRefDeclForDeclFn(@DeclarationId) + ' ' + dbo.[GetRenewalReasonFn](@DeclarationId) + '<br/>' +  isnull('(' + isnull(EType.LocalDescription, Etype.name) + ':' + Convert(varchar(2), isnull(Declarations.ExpiryPeriod, 0))  + ' / '+ Convert(nvarchar(10), Declarations.TempAdmissionExpiredOn,103) +  N' : تأريخ الإنتهاء' + ')', '' )   + CHAR(10) + dbo.GetRefDeclForHBFn(CargoVw.BaseHouseBillId) + 
		Case 
			When DEclarations.Maqasa is not null Then ' / ' + Convert(varchar(3),@MaqasaCount) + N' : عدد بيانات المقاصة'
			Else ''
		end
	...
	Declarations.NWt  AS 'Net Weight',
	      ...
	      N'  مدقق ' + ':' +  isnull(Declarations.AuditorId, '-') AS 'InspectionSuprtvisor' , 
			  ...
			  --dbo.[GetAEODeclListFn](@DeclarationId)  AS 'InspectionRemarks',
			  dbo.GetBayanInvoices_QRGCC(@DeclarationId) AS 'InspectionRemarks',      
	      --(CONVERT(varchar(20), Declarations.ReleaseDate, 103)+' / '+Declarations.ReleasedBy)  AS 'InspectionReleaseDate', 
			(dbo.fn_formatdate(ReleaseDate, 'dd/MM/yyyy hh:mm:ss tt') +N' / '+Declarations.ReleasedBy)  AS 'InspectionReleaseDate', 
              ISNULL(AgentOrg.LocalDescription,'-') AS 'ClearingAgent',  
              ISNULL(AgentOrg.TradeLicenseNumber,'-') AS 'LicenceNo',   
              Declarations.AuditorId,  
...
, '' as RiskOutcome ---atif 
 FROM Declarations   
				INNER JOIN CustomsControlProcedures ON Declarations.CustomsControlProcedureId = CustomsControlProcedures.CustomsControlProcedureId   
				inner join CargoVw on 	Declarations.DeclarationId = CargoVw.DeclarationId
				--Inner JOIN  CommercialInvoices  ON Declarations.DeclarationId = CommercialInvoices.DeclarationId   
				--Left Outer Join Locations LP ON LP.LocationId = CommercialInvoices.CountryOfOrigin 
				LEFT OUTER JOIN Organizations ConsigneeOrg ON Declarations.ConsigneeId = ConsigneeOrg.OrganizationId	
				LEFT OUTER JOIN      Declarations_ara ON Declarations.DeclarationId = Declarations_ara.DeclarationId  
				LEFT OUTER JOIN      Types DeclarationTypes ON Declarations.DeclarationType=DeclarationTypes.TypeId   
				LEFT OUTER JOIN      Locations OwnerLoc ON Declarations.OwnerLocId = OwnerLoc.LocationId    
...
GO
/****** Object:  StoredProcedure [GCC].[GCC_CustomDeclartionInquiryMainDetails]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
 ...
 BEGIN      
   ...
   BEGIN      
    ...
    BEGIN      
     ...
     EXEC [GCC].[Gcc_customdeclartioninquiryairExport] @declarationId= @DeclarationNumber ,@Phase=@phase    
    END      
    ELSE      
    BEGIN      
     IF (      
     ...
     BEGIN      
      ...
      EXEC  [GCC].[Gcc_customdeclartioninquirySeaImport] @declarationId= @DeclarationNumber ,@Phase=@phase       
       --, @LandTypeCarrier , @BillType, @ImportBillType, @TranBillType         
     END      
     ELSE IF (      
       @LandBill NOT IN (      
        ''      
     ...
     BEGIN      
      ...
      EXEC [Gcc_customdeclartioninquiryLandImport] @declarationId= @DeclarationNumber ,@Phase=@phase
	  --, @LandTypeCarrier , @BillType, @ImportBillType, @TranBillType         
     END      
     ELSE      
     BEGIN      
   ...
   BEGIN      
    IF (      
     ...
     EXEC [GCC].[Gcc_customdeclartioninquirySeaExport]  @declarationId= @DeclarationNumber ,@Phase=@phase      
    ELSE IF (      
      @LandBill NOT IN (      
       ''      
       ,'0'      
     ...
     EXEC  [GCC].[Gcc_customdeclartioninquiryLandExport]  @declarationId= @DeclarationNumber ,@Phase=@phase       
    ELSE      
     EXEC [GCC].[Gcc_customdeclartioninquiryairExport] @declarationId= @DeclarationNumber ,@Phase=@phase     
   END      
...
GO
/****** Object:  StoredProcedure [GCC].[GCC_CustomDeclartionInquiryPaymentDetails]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [GCC].[Gcc_customdeclartioninquirySeaExport]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-----------------------------
CREATE     PROCEDURE[GCC].[Gcc_customdeclartioninquirySeaExport](@DeclarationId VARCHAR(50), @Phase nvarchar(30)) AS    
BEGIN    
...
Declare @MaqasaCutOffDate datetime
select  @MaqasaCutOffDate = ConfigValue from Configurations where ConfigName='MaqasaStampCutOffDate'
--set @MaqasaCutOffDate = '2014-12-16 00:00:00'    
...
SELECT         
 isnull(dbo.TrimDecNumberFn(Declarations.DeclarationNumber), Declarations.TempDeclNumber) AS DeclarationNumber,       
   ...
   UPPER(SUBSTRING(CustomsControlProcedures.LocalDescription,0,30)) "BillType",    
DO.DeliveryOrderNumber,
   UPPER(ISNULL(ISNULL(ConsigneeOrg.LocalDescription, ISNULL(trial_ara.FirstName,'')+' '+ ISNULL(trial_ara.LastName,'')),ISNULL(trial.FirstName,'') + ' ' + ISNULL(trial.LastName,''))) AS "Consignee",
   ISNULL(DeclarationDetails_ara.CaptainName, DeclarationDetails.CaptainName) AS "Captain Name",     
   ISNULL(UPPER(ISNULL( Carriers_ara.CarrierName ,Carriers.CarrierName)),'-') "Carrier Name",    
   DeclarationDetails.VoyageFlightNo "Voyage/Flight No.",     
   ISNULL(ISNULL(DeclarationDetails_ara.BeneficiaryName, DeclarationDetails.BeneficiaryName),'-') AS 'Exported To',    
   ...
   ISNULL(ConsigneeOrg.OrganizationId,trial.PersonalId) AS ConsigneeId,      
   '' as EndorsementId,    
   'Marks: ' + dbo.GetRefDeclForDeclFn(@DeclarationId) + ' ' + case ISNULL(Declarations.HBMarks,'') when '' then ISNULL(SUBSTRING(case ISNULL(DeclarationDetails_ARA.MarksAndNumbers,'') WHEN '' THEN DeclarationDetails.MarksAndNumbers else  DeclarationDetails_ARA.MarksAndNumbers END,0,200),'')     
          else substring(Declarations.HBMarks, 0, 200) end + isnull('(' + isnull(EType.LocalDescription, Etype.name) + ':' + Convert(varchar(2), isnull(Declarations.ExpiryPeriod, 0))  + ' / '+ Convert(nvarchar(10), TempAdmissionExpiredOn,103) +  N' : تأري
...
GO
/****** Object:  StoredProcedure [GCC].[Gcc_customdeclartioninquirySeaImport]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
CREATE     PROCEDURE  [GCC].[Gcc_customdeclartioninquirySeaImport]  (
            @DeclarationId VARCHAR(50) , @Phase nvarchar(30)
		) 
AS
BEGIN
...
SELECT      
          ...
          CONVERT(CHAR(12),Declarations.DeclarationDate) AS [Date],   
  	      CustomsControlProcedures.CCPCode  as	'BillType_1',
              UPPER(SUBSTRING(CustomsControlProcedures.LocalDescription,0,30)) 'BillType',  
	      case when isnull(CargoVw.JourneyId, '') != '' then CargoVw.DeliveryOrderNumber 
				else '' End as 'DeliveryOrderNumber', 	
 	      CargoVw.ConsigneeName as 'Consignee',
	       isnull(CargoVw.ShipName,'') + ' / ' + -- + ISNULL(CargoVw.CaptainName_1, '')
	       case when CargoVw.CaptainName = '-' then ISNULL(CargoVw.CaptainName_1, '') else CargoVw.CaptainName end
	       as  'Captain Name',	
	      CargoVw.CarrierName as 'Carrier Name',
	      CargoVw.Voyage  as 'Voyage/Flight No.',
	      CargoVw.ExportedTo as 'Exported To',
 	     Case when @BWHOrgPOL <> '-' then @BWHOrgPOL  
	   ELSE ISNULL(CargoVw.PortOfLoading_Cont_Name,'-')  + ' / ' + ISNULL(UPPER(CargoVw.PortOfLoading),'-') END AS "Port Of Loading",    
	  	...
	  	'Marks: ' + CASE ISNULL(CargoVw.Marks,'') WHEN '' THEN '-' ELSE  ISNULL(SUBSTRING(CargoVw.Marks,0,100),'-') END + '<br/>' + 
	  	'Numbers: ' + ISNULL(dbo.GetRefDeclForDeclFn(@DeclarationId), '') + '  ' + dbo.[GetRenewalReasonFn](@DeclarationId) + '<br/>' +  isnull('(' + isnull(EType.LocalDescription, Etype.name) + ':' + Convert(varchar(2), isnull(Declarations.ExpiryPeriod, 0))  + ' / '+ Convert(nvarchar(10), Declarations.TempAdmissionExpiredOn,103) +  N' : تأريخ الإنتهاء' + ')', '' )  + CHAR(10) + dbo.GetRefDeclForHBFn(CargoVw.BaseHouseBillId) + ' / ' + Convert(varchar(3),@MaqasaCount) + N' : عدد بيانات المقاصة'  
		 AS Marks,
              'Marks: ' + ISNULL(CargoVw.Marks,'-')  + '<br/>' +   
              'Numbers: ' + dbo.GetContainersForHBFn_Phase3(CargoVw.HouseBillId) AS MarksAndNumbers,
			Declarations.NWt AS 'Net Weight',
		CargoVw.GWeight_NewC	AS 'Gross Weight',  
             	isnull( ISNULL(CargoVw.WtUOM_A,CargoVw.WtUOM), '') AS 'Measurement',  
                CargoVw.Quantity_NewC AS 'No of Packages',   
...
, '' as RiskOutcome ---atif 
   FROM Declarations   
			LEFT OUTER JOIN CustomsControlProcedures ON Declarations.CustomsControlProcedureId = CustomsControlProcedures.CustomsControlProcedureId   
			LEFT OUTER JOIN CargoVw on 	Declarations.DeclarationId = CargoVw.DeclarationId
			LEFT OUTER JOIN      Declarations_ara ON Declarations.DeclarationId = Declarations_ara.DeclarationId  
			LEFT OUTER JOIN      Types DeclarationTypes ON Declarations.DeclarationType=DeclarationTypes.TypeId   
			LEFT OUTER JOIN      Locations OwnerLoc ON Declarations.OwnerLocId = OwnerLoc.LocationId   
  LEFT OUTER JOIN Organizations ConsigneeOrg ON Declarations.ConsigneeId = ConsigneeOrg.OrganizationId  
...
GO
/****** Object:  StoredProcedure [GCC].[GCC_CustomsDeclarationInquiry]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [GCC].[GCC_GetSupportedDocumentListInquiry]    Script Date: 12/7/2025 1:52:14 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
CREATE     PROCEDURE [GCC].[GCC_GetSupportedDocumentListInquiry]
(
